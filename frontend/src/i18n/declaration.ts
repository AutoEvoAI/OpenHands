...
export enum I18nKey {
  ...
  COMMON$SPEC_AGENT_DESCRIPTION = "COMMON$SPEC_AGENT_DESCRIPTION",
  SPEC_AGENT$SPEC_DRIVEN_INITIALIZED = "SPEC_AGENT$SPEC_DRIVEN_INITIALIZED",
  COMMON$WORKING = "COMMON$WORKING",
  SPEC_AGENT$STAGE_INITIALIZING = "SPEC_AGENT$STAGE_INITIALIZING",
  SPEC_AGENT$STAGE_SPEC_GENERATING = "SPEC_AGENT$STAGE_SPEC_GENERATING",
  SPEC_AGENT$STAGE_SPEC_COMPLETED = "SPEC_AGENT$STAGE_SPEC_COMPLETED",
  SPEC_AGENT$STAGE_PLANNING = "SPEC_AGENT$STAGE_PLANNING",
  SPEC_AGENT$STAGE_PLANNING_COMPLETED = "SPEC_AGENT$STAGE_PLANNING_COMPLETED",
  SPEC_AGENT$STAGE_EXECUTING = "SPEC_AGENT$STAGE_EXECUTING",
  SPEC_AGENT$STAGE_COMPLETED = "SPEC_AGENT$STAGE_COMPLETED",
  SPEC_AGENT$STAGE_ERROR = "SPEC_AGENT$STAGE_ERROR",
